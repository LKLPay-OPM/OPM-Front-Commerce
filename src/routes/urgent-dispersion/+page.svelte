    ...
    <div class="modal-row">
      ...
      <div class="buttons">
        <Input
          label="Frente"
          id="buttonIneFront"
          bind:value={formINEFront}
          className={formINEFront != "" ? "btn-success" : "btn-plain"}
          type="file"
          accept="image/*,.pdf"
        />
        <Input
          label="Vuelta"
          id="buttonIneBack"
          bind:value={formINEBack}
          className={formINEBack != "" ? "btn-success" : "btn-plain"}
          type="file"
          accept="image/*,.pdf"
        />
      </div>
    ...
    <div class="modal-row">
      ...
      <div class="buttons">
        <Input
          ...
          id="form-bank-statement"
          bind:value={formBankStatement}
          className={formBankStatement != "" ? "btn-success" : "btn-plain"}
          type="file"
          accept="image/*,.pdf"
        />
      </div>
