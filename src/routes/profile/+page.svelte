  ...
  <div class="card-container padding-2">
    <div class="content">
      {#if !branchView}
        <div class="left">
          <div class="card-secondary col padding-1">
            ...
            <div class="element">
              ...
              <div class="description text-left">
                {$loggedInUser.businessAddress} {$loggedInUser.outsideNumber}
              </div>
              <div class="description text-left">
                {$loggedInUser.suburb} {$loggedInUser.zipCode}
              </div>
              <div class="description text-left">
        ...
        <div class="right">
          <Branches bind:selected={selectedBranch} branches={branches} bind:branchView/>
        </div>
      {:else}
        <div class="card-secondary col padding-1">
          <div class="element">
            ...
            <div class="avatar-container">
              <div class="avatar">
                <img class="avatar-img" alt="imagen" src="{selectedBranch.manager.avatar ? $loggedInUser.avatar : noUser}" />
              </div>
            </div>
          </div>
          <div class="element">
          ...
          <div class="element">
            ...
            <div class="description text-left">
              <Icons name={"user-fill"} width="24" height="24"/>
              {selectedBranch.manager.name} {selectedBranch.manager.firstLastName}
            </div>
            <div class="description text-left">
              <Icons name={"phone"} width="24" height="24"/>
          ...
          <div class="element">
            ...
            <div class="description text-left">
              {selectedBranch.address.street} {selectedBranch.address.outsideNumber}
            </div>
            <div class="description text-left">
              {selectedBranch.address.suburb} {selectedBranch.address.zipCode}
            </div>
            <div class="description text-left">
